...
const DICT: Record<string, Record<string, string>> = {
  ...
  'profile.stats': { hu:'◢ STATISZTIKÁK', en:'◢ STATS', de:'◢ STATISTIK', es:'◢ ESTADÍSTICAS', fr:'◢ STATS', no:'◢ STATISTIKK', sv:'◢ STATISTIK' },
  'profile.stats_title': { hu:'STATISZTIKÁK', en:'STATS', de:'STATISTIK', es:'ESTADÍSTICAS', fr:'STATS', no:'STATISTIKK', sv:'STATISTIK', ua:'СТАТИСТИКА', ru:'СТАТИСТИКА' },
